...
func TestInferencePipelineRowGet(t *testing.T) {
	...
	_, err := client.InferencePipelines.Rows.Get(
		context.TODO(),
...
func TestInferencePipelineRowDelete(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	err := client.InferencePipelines.Rows.Delete(
		context.TODO(),
		"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
		"inferenceId",
	)
