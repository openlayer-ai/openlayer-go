...
API](https://openlayer.com/docs/api-reference/rest) from applications written in Go. The full API of this library can be found in [api.md](api.md).
...
```sh
go get -u 'github.com/stainless-sdks/openlayer-go@v0.0.1-alpha.0'
```
